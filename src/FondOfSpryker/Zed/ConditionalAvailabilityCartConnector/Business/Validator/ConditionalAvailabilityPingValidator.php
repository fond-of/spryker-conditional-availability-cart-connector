...
class ConditionalAvailabilityPingValidator implements ConditionalAvailabilityPingValidatorInterface
{
     ...
     */
    public function validateItems(CartChangeTransfer $cartChangeTransfer): CartPreCheckResponseTransfer
    {
